...
// Uncomment/Comment to turn on the equation checker in the Serial Monitor^^^^^
        ...
        else if (M < 0)
        {
          ...
          // Scale Drive output due to Joystick Y input (throttle) //order of operations edit
          LMotPremixL = LMotPremixL * M / -32767.0;
          LMotPremixR = LMotPremixR * M / -32767.0;
          // Now calculate pivot amount
          // - Strength of pivot (nPivSpeed) based on Joystick X input
...
//        SecondUpESC.writeMicroseconds(1500);  /// for some reason doesn't work here
      ...
      {
        Serial.println(F("L1"));
        RightESC.writeMicroseconds(1700);
        LeftESC.writeMicroseconds(1300);
        UpESC.writeMicroseconds(1500);
      ...
      {
        Serial.println(F("R1"));
        RightESC.writeMicroseconds(1300);
        LeftESC.writeMicroseconds(1700);
        UpESC.writeMicroseconds(1500);
        SecondUpESC.writeMicroseconds(1500);
      }
      ...
      if (Xbox.getButtonClick(B, i))
      {
        ...
        LeftESC.writeMicroseconds(1500);
        UpESC.writeMicroseconds(1500);
        SecondUpESC.writeMicroseconds(1500);///// kill commands. hopefully does not confuse motors
        Serial.println(F("B"));
      }
