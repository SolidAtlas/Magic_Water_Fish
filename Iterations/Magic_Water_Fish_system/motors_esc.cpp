...
//}  
//
//void motorsclass::motorMOVE(int K, int M, int N, int O)
//{
//Serial.println();
//  Serial.print("K is");
//  Serial.println(K);
...
//}
//
//void motorsclass::motorMoveLATERAL (int K, int M, int N, int O)
//{
//
//
//  /***************************************
...
//
//
//void motorsclass::motorMoveUP (int K, int M, int N, int O)
//{
//  /***************************************
// * Lateral Motor
// */
